    ...
    <div class="container">
        <div class="d-flex flex-wrap align-it ems-center
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2
                ...
                <li><a href="/index.jsp" class="nav-link px-2 fs-6 text-white">TRANG CHỦ</a></li>
                <li><a href="#" class="nav-link px-2 text-white">NHÂN VIÊN</a></li>
                <li><a href="/customers" class="nav-link px-2 text-white">KHÁCH HÀNG</a></li>
                <li><a href="/facility" class="nav-link px-2 text-white">DỊCH VỤ</a></li>
