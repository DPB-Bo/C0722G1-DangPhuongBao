...
public class Customer {
    ...
    public Customer(int id, String name, String birthday, boolean gender, String idCard, String phoneNumber, String email, String address, int customerTypeId,boolean isDelete) {
        this.id = id;
        this.name = name;
        this.birthday = birthday;
        this.gender = gender;
