...
<div class="container">
                        ...
                        <div class="container">
                            <div class="mb-3">
                                <div class="d-flex gap-3">
                                    ...
                                    <div>
                                        <input required type="text" id="addProductName"
                                               name="addProductName">
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
                                <div class="d-flex gap-3">
                                    ...
                                    <div>
                                        <input required id="addProductPrice"
                                ...
                                <div class="d-flex gap-3">
                                    ...
                                    <div>
                                        <input required type="text"
                                               id="addProductDes" name="addProductDes">
                            ...
                            <div class="mb-3">
                                <div class="d-flex gap-3">
                                    <label for="addProductProducer"
                                           class="form-label">PRODUCT PRODUCER: </label>
                                    <div>
                                        <input required type="text"
                                               name="addProductProducer" id="addProductProducer">
                                    </div>
                                </div>
                            </div>
    ...
    <table class="table">
        ...
        <c:forEach var="product" items="${products}" varStatus="status">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="/productServlet?action=delete&productId=${product.getId()}" type="button"
                               class="btn btn-primary">CÓ</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal fade" id="editProduct${product.getId()}" tabindex="-1"
                 aria-labelledby="exampleModalLabel" aria-hidden="true"
                 data-bs-backdrop="static">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="/productServlet?action=edit&productId=${product.getId()}" method="post">
                            <div class="modal-body">
                                <div class="container">
                                    ...
                                    <div class="mb-3">
                                        <div class="d-flex gap-3">
                                            <label for="editProductName"
                                                   class="form-label">PRODUCT NAME: </label>
                                            <div>
                                                <input value="${product.getName()}" type="text" id="editProductName"
                                                       name="productName">
                                    ...
                                    <div class="mb-3">
                                        <div class="d-flex gap-3">
                                            <label for="editProductPrice"
                                                   class="form-label">PRODUCT PRICE: </label>
                                            <div>
                                                <input value="${product.getProductPrice()}" id="editProductPrice"
                                                       name="productPrice">
                                    ...
                                    <div class="mb-3">
                                        <div class="d-flex gap-3">
                                            <label for="editProductDes"
                                                   class="form-label">PRODUCT DESCRIPTION: </label>
                                            <div>
                                                <input value="${product.getDescription()}" type="text"
                                                       id="editProductDes" name="productDes">
                                    ...
                                    <div class="mb-3">
                                        <div class="d-flex gap-3">
                                            <label for="editProductProducer"
                                                   class="form-label">PRODUCT PRODUCER: </label>
                                            <div>
                                                <input value="${product.getProducer()}" type="text"
                                                       name="productProducer" id="editProductProducer">
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="modal fade" id="showDetails${product.getId()}" tabindex="-1"
                 aria-labelledby="exampleModalLabel" aria-hidden="true"
                 data-bs-backdrop="static">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="container">
                                <form>
                                    ...
                                    <div class="mb-3">
                                        <div class="d-flex gap-3">
                                            <label for="productProducer"
                                                   class="form-label">PRODUCT PRODUCER: </label>
                                            <div>
                                                <b id="productProducer">
                                                        ${product.getProducer()}
                                                </b>
                                            </div>
                                        </div>
